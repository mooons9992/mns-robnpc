-- Version Check System for mns-robnpc
local resourceName = GetCurrentResourceName()
local currentVersion = GetResourceMetadata(resourceName, 'version', 0)
local repositoryUrl = 'https://github.com/mooons9992/mns-robnpc'
local versionCheckEndpoint = 'https://raw.githubusercontent.com/mooons9992/mns-robnpc/main/version.json'
